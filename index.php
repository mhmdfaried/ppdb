...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/N0LmdoMY2z4"
            ...
            <br>
            <p class="masthead-subheading font-weight-light mb-0">“Sekolah umum berbasis Keagamaan Berkarakter Akhlak
                Mulia, Pilihan anak – anak terpilih”</p>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ms-auto">
                    <h3>Visi & Motto</h3>
                    <p class="lead">Terwujudnya siswa – siswi sebagai calon tenaga kerja yang berkarakter Akhlak Mulia,
                        Cerdas, & Terampil.
                        <br><br>
                        Berawal dari Masjid, berakhir di Masjid.
                    </p>
                </div>
                <div class="col-lg-4 me-auto">
                    <h3>Identitas Sekolah</h3>
                    <p class="lead">Sekolah Umum Berbasis Keagamaan Berkarakter Akhlak Mulia, Pilihan Anak – anak
                        terpilih</p>
                </div>
            </div>
        </div>
